...
# get path to basemap
basepath_data = titaniach / 'lineament_detection/global_maps_for_book/data/for_analysis/geotiffs/Enceladus/'
...
for tifffile in tifpaths:
    ...
    savepath = 'z:/Groups/PIG/Caroline/lineament_detection/global_maps_for_book/output/LineaMapper_Enceladus/' + dt_string + tf
    ...
    command = 'python LineaMapper_v2_to_img.py --geofile=z:/Groups/PIG/Caroline/lineament_detection/global_maps_for_book/data/for_analysis/geotiffs/Enceladus/' + tf + '.tif --savedir=' + savepath + ' --geosize=200 --cut_size=600 --class_scores 0.5 0.3 0.5 0.3 --azimuth_diff_range=25 --del_pxs=100 --multiplication_factor=25'
