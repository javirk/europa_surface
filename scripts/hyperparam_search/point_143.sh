...
PYTHONPATH="./" python main.py --batch-size=128 --lr=0.0005250000000000001 --wd=0.01 --epochs=50 --workers 8 \
  --data-location=/storage/workspaces/artorg_aimi/ws_00000/javier/datasets/europa/dataset_224x224/ \
  --eval-datasets=GalileoDataset --train-dataset=Galileo --loss-fn=DiceLoss,CrossEntropyLoss,IoUHeadLoss --loss-weights=1.,2.,1. \
