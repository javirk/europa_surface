...
PYTHONPATH="./" python main.py --task=testing \
  ...
  --exp-name=Galileo --save=./results/ --pretrained-model=./segment_anything/checkpoints/sam_vit_b_01ec64.pth \
  --testing-ckpt ./ckpts/semseg.pt --model vit_b