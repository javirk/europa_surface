...
def build_sam_vit_b_encoderadapter(checkpoint=None, train_encoder=False, train_prompt_encoder=True, train_decoder=True,
                                   num_classes=3, image_size=512):
    return _build_sam_encoderadapter(
        encoder_embed_dim=768,
        encoder_depth=12,
        encoder_num_heads=12,
        encoder_global_attn_indexes=[2, 5, 8, 11],
...
def build_sam_vit_b_adapter(checkpoint=None, train_encoder=False, train_prompt_encoder=False, train_decoder=False,
                            num_classes=3, image_size=512):
...
def build_sam_vit_b_biggeradapter(checkpoint=None, train_encoder=False, train_prompt_encoder=False, train_decoder=False,
                                  num_classes=3, image_size=512):
    return _build_sam_biggeradapter(
        encoder_embed_dim=768,
        encoder_depth=12,
        encoder_num_heads=12,
        encoder_global_attn_indexes=[2, 5, 8, 11],
...
sam_model_registry = {
    ...
    "vit_b_encoder_adapter": build_sam_vit_b_encoderadapter,
    "vit_b_biggeradapter": build_sam_vit_b_biggeradapter,
}
...
def _build_sam_adapter(
    ...
    sam = Sam(
        ...
        mask_decoder=MaskDecoder(
            num_multimask_outputs=num_classes,
            transformer=TwoWayTransformerAdaption(
                depth=2,
                embedding_dim=prompt_embed_dim,
                mlp_dim=2048,
                num_heads=8,
...
def _build_sam_biggeradapter(
    ...
    sam = Sam(
        ...
        prompt_encoder=PromptEncoder(  # It was PromptDomainEncoder before
            embed_dim=prompt_embed_dim,
            image_embedding_size=(image_embedding_size, image_embedding_size),
            input_image_size=(image_size, image_size),
            mask_in_chans=16,
        ...
        mask_decoder=MaskDecoder(
            num_multimask_outputs=num_classes,
            transformer=TwoWayTransformerBiggerAdaption(
                depth=2,
                embedding_dim=prompt_embed_dim,
                mlp_dim=2048,
                num_heads=8,
